...
public class ObjIns {
    ...
    public ObjIns(Obj parent, Vector origin, Vector rotation, Vector conRot, Vector[] move, int objInsNumber, int number) {
        this.parent = parent;
        this.boundSph = this.parent.bR;
        this.rotation = rotation;
        this.conRot = conRot;
    ...
    public String toString() {
        return new String("oi " + this.objInsNumber + " " + this.origin.x + " " + this.origin.y + " " + this.origin.z + " " + this.rotation.x + " " + this.rotation.y + " " + this.rotation.z);
    }
}
